...
/**
 * ListOrdersApi Class Doc Comment
 *
 * @category Class
 * @package  Grab\GrabfoodApiSdk
 * @author   OpenAPI Generator team
...
class ListOrdersApi
{
    ...
    public function listOrdersWithHttpInfo($authorization, $merchant_id, $date, $page, string $contentType = self::contentTypes['listOrders'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Grab\GrabfoodApiSdk\Model\ListOrdersResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Grab\GrabfoodApiSdk\Model\ListOrdersResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Grab\GrabfoodApiSdk\Model\ListOrdersResponse', []),
    ...
    public function listOrdersRequest($authorization, $merchant_id, $date, $page, string $contentType = self::contentTypes['listOrders'][0])
    {
        ...
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling listOrders'
            );
        }
        ...
        if ($merchant_id === null || (is_array($merchant_id) && count($merchant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $merchant_id when calling listOrders'
            );
        }
