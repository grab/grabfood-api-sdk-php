...
/**
 * CampaignScope Class Doc Comment
 *
 * @category Class
 ...
 */
class CampaignScope implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'campaignScope';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The scope type for this campaign.  * `order` - order level campaign. * `items` - item level campaign or bundle offer.  * `category` - category level campaign where all items within applies the same discount.
     *
     * @return self
     */
