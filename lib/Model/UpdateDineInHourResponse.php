...
/**
 * UpdateDineInHourResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateDineInHourResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDineInHourResponse';
    ...
    */
     ...
     * Sets error_reasons
     *
     * @param string[]|null $error_reasons Error message when updating store dine-in hour. `null` indicates no error.
     *
     * @return self
     */
