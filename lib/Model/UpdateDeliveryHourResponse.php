...
/**
 * UpdateDeliveryHourResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateDeliveryHourResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDeliveryHourResponse';
    ...
    public const ERROR_REASONS_CLOSING_HOURS_INEFFECTIVE = 'ClosingHoursIneffective';
    public const ERROR_REASONS_FORCE_UPDATED = 'ForceUpdated';
    public const ERROR_REASONS_PENDING_SCHEDULED_ORDERS = 'PendingScheduledOrders';
    ...
    {
        return [
            self::ERROR_REASONS_CLOSING_HOURS_INEFFECTIVE,
            self::ERROR_REASONS_FORCE_UPDATED,
            self::ERROR_REASONS_PENDING_SCHEDULED_ORDERS,
    ...
    */
     ...
     *
     * @param bool $close_immediately Indicate the store status after updating delivery hours.
     *
     * @return self
     */
