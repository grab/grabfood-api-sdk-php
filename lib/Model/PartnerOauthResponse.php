...
/**
 * PartnerOauthResponse Class Doc Comment
 *
 * @category Class
 * @package  Grab\GrabfoodApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class PartnerOauthResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerOauthResponse';
    ...
    */
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in The access token lifespan in seconds.
     *
     * @return self
     */
