...
/**
 * UnlinkMembershipWebviewRequest Class Doc Comment
 *
 * @category Class
 * @description This request submits membership unbind request to partner.
 * @package  Grab\GrabfoodApiSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UnlinkMembershipWebviewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnlinkMembershipWebviewRequest';
