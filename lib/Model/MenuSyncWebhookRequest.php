...
/**
 * MenuSyncWebhookRequest Class Doc Comment
 *
 * @category Class
 * @description This request pushes the state of a menu sync operation.
 * @package  Grab\GrabfoodApiSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MenuSyncWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MenuSyncWebhookRequest';
    ...
    */
     ...
     * Sets request_id
     *
     * @param string|null $request_id An universally unique identifier (UUID) string. Used to uniquely identify a webhook request. Partners should use this value to distinguish between different webhook requests. If two requests contain the same requestID, only the first request should be considered and later requests **must** be ignored or discarded.
     *
     * @return self
     */
     ...
     * Sets job_id
     *
     * @param string|null $job_id An UUID string. Uniquely identifies a menu sync job. This can be found from the [Menu Update Notification](#tag/update-menu-noti) API response header.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at Indicates the time of menu sync status change. This is based on ISO_8601/RFC3339. For example: `2022-07-29T15:55:59Z`.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Indicates the state of the menu sync job.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param string[]|null $errors A string array of errors that occurred during processing. This array is empty if the status is not `FAILED`.
     *
     * @return self
     */
