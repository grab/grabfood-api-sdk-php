...
/**
 * MenuModifier Class Doc Comment
 *
 * @category Class
 * @package  Grab\GrabfoodApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class MenuModifier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MenuModifier';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The modifier's ID that is on the partner's system. This ID should be unique.
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $id when calling MenuModifier., must be smaller than or equal to 64.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MenuModifier., must be smaller than or equal to 40.');
        }
     ...
     *
     * @param array<string,string>|null $name_translation Translation of the modifier name. Only support up to 1 translated language. Refer [Menu Translation](#section/Menu-Translation).
     *
     * @return self
     */
     ...
     *
     * @param string $available_status The status for the modifier. Refer to FAQs for more details about [availableStatus](#section/Menu/What-is-availableStatus).
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param int|null $price The modifier's price in minor format. Refer to FAQs for more details about [tax](#section/Menu/Is-the-menu-price-with-or-without-tax).
     *
     * @return self
     */
     ...
     * Sets barcode
     *
     * @param string|null $barcode The barcode Number (GTIN). GTIN must be 8, 12, 13, 14 numeric digits.
     *
     * @return self
     */
    public function setBarcode($barcode)
    {
        ...
        if ((mb_strlen($barcode) > 64)) {
            throw new \InvalidArgumentException('invalid length for $barcode when calling MenuModifier., must be smaller than or equal to 64.');
        }
     ...
     * Sets sequence
     *
     * @param int|null $sequence The sort or display order of the modifier within the menu.
     *
     * @return self
     */
