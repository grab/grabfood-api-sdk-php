...
/**
 * CreateSelfServeJourneyResponse Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Grab\GrabfoodApiSdk
 ...
 */
class CreateSelfServeJourneyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSelfServeJourneyResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['activation_url'] === null) {
            $invalidProperties[] = "'activation_url' can't be null";
        }
     ...
     * Sets activation_url
     *
     * @param string $activation_url A JSON object containing store information
     *
     * @return self
     */
