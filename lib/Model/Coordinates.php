 ...
 *
 * @category Class
 * @description A JSON object containing the coordinates of the delivery address. Only has value when poiSource is &#x60;GRAB&#x60;.
 * @package  Grab\GrabfoodApiSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Coordinates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets latitude
     *
     * @param float|null $latitude The latitude coordinates of the delivery address.
     *
     * @return self
     */
     ...
     * Sets longitude
     *
     * @param float|null $longitude The longitude coordinates of the delivery address.
     *
     * @return self
     */
