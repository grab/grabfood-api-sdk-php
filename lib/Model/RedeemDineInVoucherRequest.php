...
/**
 * RedeemDineInVoucherRequest Class Doc Comment
 *
 * @category Class
 * @description Dine in voucher redemption
 * @package  Grab\GrabfoodApiSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RedeemDineInVoucherRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RedeemDineInVoucherRequest';
    ...
    */
     ...
     * Sets certificate_id
     *
     * @param string $certificate_id This certificateID is decoded from scanning the QR code, and 1:1 mapping with `voucherCode`.
     *
     * @return self
     */
