...
/**
 * RegisterMembershipNativeResponse Class Doc Comment
 *
 * @category Class
 * @description This response returns membershipID after membership binding is successful.
 * @package  Grab\GrabfoodApiSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RegisterMembershipNativeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegisterMembershipNativeResponse';
    ...
    */
     ...
     * Sets member_id
     *
     * @param string $member_id The unique member ID on the partner's database.
     *
     * @return self
     */
